            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <a href="edit/edit_ann.php" class="view"><i class="fa-solid fa-plus"></i></a> 
                        </div>
                                                ...
                                                if ($num>0) {  
                                                    while($data=mysqli_fetch_assoc($connect)){
                                                        ...
                                                        ?>
                                                            ...
                                                            <td><?= $data['subject']; ?></td>
                                                            <td><?= $data['announce']; ?></td>
                                                            <td><button class="pending">Sent</button></td>

                                                            <td > 
                                                            <a href="delete/ann_delete.php?id=<?= $data['id']; ?>" class="delete"><i class='fa-solid fa-rectangle-xmark xmark' style="margin-right: 3%;"></i></a>  </td>
                                                            </tr>  
