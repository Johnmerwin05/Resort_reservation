...
<body>
    ...
    <div class="breadcrumb-area contact-breadcrumb bg-img bg-overlay jarallax" style="background-image: url(img/bg-img/dj6.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-12">
    ...
    <section class="google-maps-contact-info">
        <div class="container-fluid">
            <div class="google-maps-contact-content">
                <div class="row">
                    ...
                    <div class="col-6 col-lg-3">
                        <div class="single-contact-info">
                            ...
                            <h4>Address</h4>
                            <p style="font-size: small;">Lot 5 Taniqui Street Barangay 4231, Nasugbu, Batangas</p>
                        </div>
                    </div>
                    <!-- Single Contact Info -->
                    <div class="col-6 col-lg-3">
                ...
                <iframe height="320px" class="w-100 rounded" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3870.173113926985!2d120.62287231483408!3d14.066952690144158!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x33bd97d3a3937477%3A0x423061b541f1cc46!2sDrimJoy%20Beach%20Resort!5e0!3m2!1sen!2sph!4v1666416758956!5m2!1sen!2sph"  loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="roberto-contact-form">
                        <form action="book_database/contact.php" method="post">
                            <div class="row">
                                ...
                                <div class="col-12 text-center wow fadeInUp" data-wow-delay="100ms">
                                    <button type="submit" name="submit" class="btn roberto-btn mt-15">Send Message</button>
                                </div>
                            </div>
                        </form>
                    </div>
